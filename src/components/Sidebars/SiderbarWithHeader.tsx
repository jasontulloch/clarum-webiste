                  ...
                  <ul role="list" className="flex flex-1 flex-col gap-y-7">
                    <li>
                      <ul role="list" className="-mx-2 space-y-1">
                        {screens?.institutionalInvestorScreens?.map((item) => {    
                          ...
                          <li key={company.name}>
                            ...
                            >
                              <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border border-gray-700 bg-gray-800 text-[0.625rem] font-medium text-gray-400 group-hover:text-white">
                                {company.initial === '' ? company.name.slice(0,2) : company.initial}
                              </span>
            ...
            <nav className="flex flex-1 flex-col">
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                <li>
                  <ul role="list" className="-mx-2 space-y-1">
                    {screens?.institutionalInvestorScreens?.map((item) => {
                        if (item.position === 'sideappbar' && ((item.isIncludeOnLanding && portfolioCompany.id === 0) || (!item.isIncludeOnLanding && portfolioCompany.id !== 0))) {
                            return (
                                <li key={item.path}>
                                    <a
                                        onClick={() => handleRedirect(item.path)}
